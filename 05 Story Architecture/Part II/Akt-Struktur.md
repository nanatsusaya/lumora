...
- Wiedergeborener Protagonist lernt Umgebung kennen.
...
- Forscht den Stammbaum, erkundet die Welt außerhalb.
- Lernt viele Gleichaltrige — darunter [[Der Junge]] (Hassliebe-Dynamik).
- **Drachenwesen-Angriff. Der Junge stirbt.**
...
## Schlüsselszenen (Archivmaterial)
...
**Der Boden ist Lava:** Protagonistin erfindet das Spiel neu, andere Kinder kennen es nicht. Endet mit: *„Die Küche sei sicher." — „Aber die ist zwei Stockwerke unter uns!" — Protagonistin mit ernstem Blick: „Das Abenteuer beginnt!"*
...
```
TODO: Wie viele Kapitel umfasst Part II?
TODO: Pacing ausbalancieren — Slice-of-Life-Momente (Mode, Training, Schule)
      müssen mit Spannung und Fortschritt verzahnt sein.
TODO: Kleider-Subplot und Psychoangriff-Training können parallel laufen.
```
