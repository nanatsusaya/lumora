...
Die **Volari** (klassischer Fantasy-Begriff: *Vogelmenschen / Aviane*) sind das flugfähige Vogelvolk Lumoras — eine der zwölf kulturschaffenden [[Spezies]]. *Volari* ist ihr [[Waldelværi#Die Völker im Elværin (Waldelværi-Exonyme)|Elværin-Name]] (von lat. *volare*, „fliegen“ → „die Himmelsstürmer“). Sie sind ein hochspezialisiertes Flugvolk und eine eigenständige evolutionäre Linie, die sich ohne abschließende göttliche Formung weitgehend selbst entwickelt hat.

**Steckbrief**

- **Elværin-Name:** Volari (`-ari`, „die Himmelsstürmer“)
- **Fantasy-Pendant:** Vogelmenschen / Aviane
- **Schöpfergott:** kein klar definierter (→ [[#Herkunft]])
- **Lebensraum:** Regionen mit verlässlichem Aufwind — Hochgebirge, Küstenklippen, Schluchten, thermikreiche Ebenen; außerhalb noetischer Hotspots
- **Bevölkerung:** ~30 Mio.
- **Lebensspanne:** kurz, ~30 Jahre (→ [[#N-Kraft]])
- **N-Kraft-Schwerpunkt:** Gravitation (eng spezialisiert)
- **Status:** #wip

## Herkunft

Die Volari haben keinen klar definierten Schöpfergott. Ihre Linie geht auf das [[02.05 Geschichte#Das fremde Saatgut — der Fremdbringer|Fremdbringer-Saatgut]] zurück (→ [[Der gemeinsame Ursprung]]), wurde aber — anders als die übrigen verwandten Völker — nicht von einem Gott bis zur Reife geführt. Sie zählen zu den jüngsten kulturschaffenden Völkern und haben sich weitgehend natürlich entwickelt. Daraus erklären sich ihre schmale noetische Begabung und das Fehlen einer Volksreligion. *(Verborgene Genealogie → [[Der gemeinsame Ursprung]]; göttlicher Hintergrund → [[Volari-Gott]].)*
...
**Beine:** lang und federleicht; die sichtbare rückwärtige Beugung stammt vom verlängerten Fußgelenk, nicht vom Knie (wie bei Vögeln).
...
Die Volari sind eng auf einen einzigen noetischen Effekt spezialisiert: die Verringerung der eigenen Gravitationsmasse. Andere Anwendungen fallen ihnen so schwer, dass sie praktisch ungenutzt bleiben — eine Folge ihrer weitgehend natürlichen, nicht göttlich verfeinerten Entwicklung (→ [[03.03 Das Noetische Profil]]).

Dieser Effekt wird im Flug **dauerhaft aufrechterhalten** und ist damit energetisch teuer (→ [[03.05 Grenzen & Einschränkungen]]). Anatomisch sind Volari maximal darauf optimiert — effizient genug für den täglichen Dauerflug, aber nicht für ein langes Leben. Außerhalb der Hotspots, wo der Einsatz der N-Kraft ungleich schwerer ist, tragen sie diese Last ihr ganzes Leben. Evolutionär hat das eine „live fast“-Strategie geformt: Spitzenleistung im Flug gegen kurze Lebensdauer von ~30 Jahren (→ [[03.07 Noetische Evolution]]). Wer weniger fliegt — etwa sesshafte Volari —, lebt entsprechend länger (→ [[Volari-Gesellschaft]]).
...
Matriarchal organisiert, mit zugvogelartiger Wanderlebensweise und einer Spaltung in wandernde Traditionalisten und sesshafte Volari. Ausführlich → [[Volari-Gesellschaft]].

## Religion

Keine Volksreligion. Volari folgen regional unterschiedlichen Göttern oder verehren gar keinen (→ [[02.04 Religion & Götter]]).

## Offene Fragen

```
TODO:
- Lage der Brutplätze und Timing von Eiablage/Schlüpfen/Übergabe im 8-Jahreszeiten-Zyklus (→ Geografie-Arbeit).
- Reichweite und Kosten der Gravitationsreduktion konkret beziffern.
- Verhältnis zu den Bythari um Küsten- und Wasserressourcen.
```
