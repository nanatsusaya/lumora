...
> *Kernaussage:* Orthyros steht **nahe dem Mittelpunkt** von Lumoras Bahnellipse, nicht in einem Brennpunkt. Das ist physikalisch nur möglich, wenn Lumora sich innerhalb einer ausgedehnten, gleichförmig verteilten Masse bewegt — dem [[#Der dunkle Halo|dunklen Halo]] um Orthyros.

---

## Die Gummiband-Bahn

Gewöhnliche Monde umkreisen ihren Planeten auf einer Keplerellipse mit dem Planeten in einem **Brennpunkt** — eine Seite der Bahn ist eng, die andere weit, mit **einer** nahen und **einer** fernen Stellung pro Umlauf.

Lumora dagegen folgt einer **„Gummiband"-Bahn**: Eine Kraft, die mit dem Abstand *wächst* statt zu fallen, hält Orthyros im **Zentrum** der Ellipse. Die Folge ist eine **punktsymmetrische** Bahn — Lumora kommt Orthyros **zweimal pro Umlauf** am nächsten (an den Enden der kurzen Achse) und steht **zweimal** am fernsten (an den Enden der langen Achse). Genau daraus ergeben sich die [[#Die zwei Jahreszyklen|zwei Sommer und zwei Winter]] pro Jahr.

Das Achsverhältnis der Ellipse beträgt grob **2:1** — die ferne Stellung ist etwa doppelt so weit wie die nahe. Wie bei einem Pendel bewegt sich Lumora **in Orthyros-Nähe am schnellsten**, in der Ferne am langsamsten.

*(Warum allein ein lineares Kraftgesetz den Zentralkörper in die Mitte rückt — Bertrand-Theorem, harmonischer Oszillator, Schalentheorem — steht in [[Keplerbahnen & zentrale Kräfte]].)*

---

## Der dunkle Halo

Die „Gummiband"-Kraft verlangt eine **ausgedehnte, annähernd gleichförmig verteilte Masse**, in der Lumora sich bewegt und die im Bahnbereich schwerer wiegt als Orthyros selbst. Diese Masse ist der **dunkle Halo**: ein weiträumiger, kugeliger Schwarm aus dunklem Geröll und feinem Staub um Orthyros.

- **Unsichtbar.** Der Halo leuchtet nicht, ist extrem dünn verteilt (geringe Flächenhelligkeit) und liegt als diffuse, dreidimensionale Wolke vor — **kein** heller, dünner Ring. Vor Aezions hellem Himmel und dem großen Orthyros bleibt er mit bloßem Auge verborgen. Er ist damit ausdrücklich etwas anderes als der sichtbare [[Sonnensystem#Orthyros — der Gasriese|Äquatorgürtel]] aus Myzel.
- **Stabil ohne Nachschub.** Die Masse steckt vor allem in **großem, dunklem Geröll**, das von Strahlungsdruck und Drift kaum betroffen ist und über die gesamte Lebensdauer Aezions stabil bleibt — wie ein Asteroidengürtel. Der **feine Staub** (der die obere Atmosphäre Lumoras reibt, siehe unten) wird durch Kollisionen im Geröll laufend **nachproduziert** — eine Kollisionskaskade, wie sie reale Trümmerscheiben tragen.
- **Herkunft.** Der Halo ist **primordial** — Teil des stabil aufgebauten Systems, auf das der [[Ursprungsgott]] traf. Seine Hauptmasse stammt **nicht** vom zerstörten Planeten [[Sonnensystem#Soluthar — der zerstörte Planet|Soluthar]] (dessen Gesteinsmasse wäre dafür zu gering); Soluthar lieferte nur das leuchtende Myzel und etwas Zusatzstaub.
...
Orthyros erscheint als große, bleiche Scheibe mit Wolkenbändern und dem hellen Äquatorfaden — **nicht** als himmelfüllende Wand. Seine scheinbare Größe „atmet" mit den Jahreszeiten: im **Winter** (fern) etwa **mondgroß**, im **Sommer** (nah) rund **doppelt so groß**.

> *Warum nicht größer?* Ein Mond, der seinen Planeten den halben Himmel füllen ließe, müsste ihn in **Tagen** umkreisen. Lumoras Jahr (ein Umlauf) dauert aber **629 Tage** (≈ 1,9 Erdjahre); ein so langer Umlauf zwingt zu einer weiten Bahn und damit zu einem **mond- bis doppelt-mondgroßen** Orthyros.
...
- Reale Physik der Bahnformen → [[Keplerbahnen & zentrale Kräfte]]
- Aezion, Orthyros, Soluthar, Belichtung, Apsiden → [[Sonnensystem]]
- Tag, Monat, Jahr, Jahreszeiten, Licht-/Dunkeltag → [[Zeitrechnung]]
